...
1. Initialize your repository (project folder) as a Git project and connect to GitHub.
...
5. Repeat steps 2–4.
6. Pull in any possible changes made by others on the GitHub repository.
6. Push your changes to GitHub repository.

There are many different ways you can go about doing these foundational steps. Adding in GitHub to the mix brings in further complexity. Do you create the repository on GitHub first or on your computer. Let's go through creating a repository on [GitHub first](#github-first), which makes things a bit easier because each step actually combines multiple steps into one. Then, we will go through how to get a project on your computer onto GitHub.
...
### 4. Pull any changes from GitHub
Before pushing your changes to GitHub, it is a good idea to pull in any changes that others have made to the GitHub repository while you have been doing your work.

1. Click on the blue `Pull` button in the RStudio Git tab.
2. Deal with any conflicts.
...
1. Click on the green `Push` button in the RStudio Git tab to send your changes to GitHub.
2. Confirm that the changes are on GitHub by going to the url of the repository.
...
5. **Pull** any changes made by others on GitHub.
