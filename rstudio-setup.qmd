...
![An R session running in the Terminal app.](files/img/r-in-terminal.png){#fig-terminal width=80% fig-alt="A screen shot of R running in the Terminal application."}
...
![RStudio Global Options: Set these options for the Workspace.](files/img/rstudio-workspace.png){#fig-workspace width=75% fig-alt="A screen shot of the Settings window for RStudio."}
